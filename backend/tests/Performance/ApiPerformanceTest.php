...
class ApiPerformanceTest extends AbstractWebTestCase
{
    ...
    public function testProjectListPerformance(): void
    {
        ...
        $this->assertLessThan(self::RESPONSE_TIME_THRESHOLD, $responseTime,
    ...
    public function testConcurrentLikeRequestsPerformance(): void
    {
        ...
        foreach ($responses as $response) {
            $this->assertLessThan(self::RESPONSE_TIME_THRESHOLD, $response['response_time'],
                sprintf('Request to %s took %.3fs, should be under %.3fs', 
                    $response['endpoint'], $response['response_time'], self::RESPONSE_TIME_THRESHOLD));
        ...
        $this->assertLessThan(0.8, $totalTime, 
